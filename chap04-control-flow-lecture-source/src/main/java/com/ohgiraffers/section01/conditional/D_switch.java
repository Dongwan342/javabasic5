...
public class D_switch {
    ...
    public void testSimpleSwitchStatement(){
        ...
        * }
         ...
         * 필기.
         * 여러 개의 비교값 중 일치하는 조건에 해당하는 로직을 실행하는 것은 if - else - if와 유사함
         * 따라서 일부 호환이 가능
         * 하지만, switch 문으로 비교 가능한 값은 정수, 문자, 문자열의 형태임
         * 실수와 논리는 비교할 수 없음
         * 또한 정확하게 일치하는 경우만 비교할 수 있으며, 대소 비교를 할 수 없다는 게 차이점

         /* 필기.
         * 정수 두 개와 연산 기호 문자를 입력받아 두 숫자의 연산 결과를 출력해보는 간단한 계산기를 만들어 보자.
         *  */
    ...
    public void testSwitchVendingMachine(){
        ...
        switch (selectDrink) {
            ...
            case "사이다" :
                System.out.println("사이다를 골랐습니다");
                price = 1500;
                break;

            case "콜라" :
                System.out.println("콜라를 골랐습니다");
                price = 2000;
                break;

            case "포카리" :
                System.out.println("포카리를 골랐습니다");
                price = 3000;
                break;

            case "솔의눈" :
                System.out.println("솔의눈을 골랐습니다");
                price = 200;
                break;

            case "맥콜" :
                System.out.println("맥콜을 골랐습니다");
                price = 500;
                break;
        }

        System.out.println(price + "원을 넣어 주세요");
