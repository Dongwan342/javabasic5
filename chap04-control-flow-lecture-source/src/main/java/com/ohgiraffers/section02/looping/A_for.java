...
public class A_for {
    ...
    public void testForExample1() {
        ...
        /* 필기. 5명의 학생 이름을 입력받아 이름을 출력해 보자. */
        Scanner sc = new Scanner(System.in);

        System.out.print("첫번째 학생의 이름을 입력해 주세요 : ");
        String student1 = sc.nextLine();
        System.out.println("첫번째 학생의 이름은 " + student1 + "입니다.");

        System.out.println("두번째 학생의 이름을 입력해 주세요. : ");
        String student2 = sc.nextLine();
        System.out.println("두번째 학생의 이름은 " + student2 + "입니다.");

        System.out.println("세번째 학생의 이름을 입력해 주세요. : ");
        String student3 = sc.nextLine();
        System.out.println("세번째 학생의 이름은 " + student3 + "입니다.");

        System.out.println("네번째 학생의 이름을 입력해 주세요. : ");
        String student4 = sc.nextLine();
        System.out.println("네번째 학생의 이름은 " + student4 + "입니다.");

        System.out.println("다섯번째 학생의 이름을 입력해 주세요. : ");
        String student5 = sc.nextLine();
        System.out.println("다섯번째 학생의 이름은 " + student5 + "입니다.");
        ...
        for (int i = 1; 1 <= 5; i++) {
            ...
            public void testForExample2(){
                ...
                * */
                ...
                /* 필기.
                * 5~10 사이의 난수를 발생시켜 1부터 발생한 난수까지의 합계를 구해 보자.
                * */
    ...
    public void testForExample4(){
        ...
        *  */
        ...
        /* 필기.
        * 결국 작은 수부터 시작해서 큰 수까지의 합계를 구하는 것이기 때문에 first와 second 중 어느 것이 큰수인지 확인하면
        작은 수 ~ 큰 수까지의 합계를 구하는 로직으로 바꿀 수 있다.
        *  */
    ...
    public void printSimpleGugudan() {
        ...
        * 2~9 사이인 경우 해당 안의 구구단을 출력하고, 그렇지 않은 경우 "반드시 2~9 사이의 양수를 입력해야 합니다" 출력
         */
